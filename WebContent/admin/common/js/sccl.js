...
$(function(){
	...
	/*菜单json*/
	var menu = [{"id":"01","name":"主菜单","parentId":"0","url":"","icon":"","order":"2","isHeader":"1","childMenus":[
					{"id":"0101","name":"分类管理","parentId":"01","url":"","icon":"","order":"1","isHeader":"0","childMenus":[
						{"id":"010101","name":"一级分类管理","parentId":"0101","url":"${pageContext.request.contextPath}/adminCategory_findAll.action","icon":"","order":"1","isHeader":"0","childMenus":""},
						{"id":"010102","name":"二级分类管理","parentId":"0101","url":"${pageContext.request.contextPath}/adminCategorySecond_findAll.action?page=1","icon":"","order":"1","isHeader":"0","childMenus":""}
					]},
					{"id":"0102","name":"商品管理","parentId":"01","url":"","icon":"","order":"1","isHeader":"0","childMenus":[
						{"id":"010201","name":"商品列表","parentId":"0102","url":"${pageContext.request.contextPath}/adminProduct_findAll.action?page=1","icon":"","order":"1","isHeader":"0","childMenus":""},
						{"id":"010202","name":"搜索功能（待做）","parentId":"0102","url":"test1.html","icon":"","order":"1","isHeader":"0","childMenus":""}
					]},
					{"id":"0103","name":"订单管理","parentId":"01","url":"","icon":"","order":"1","isHeader":"0","childMenus":[
						{"id":"010301","name":"所有订单","parentId":"0103","url":"${pageContext.request.contextPath}/adminOrder_findAll.action?page=1","icon":"","order":"1","isHeader":"0","childMenus":""},
						{"id":"010302","name":"未付款订单","parentId":"0103","url":"${pageContext.request.contextPath}/adminOrder_findByState.action?page=1&state=1","icon":"","order":"1","isHeader":"0","childMenus":""},
						{"id":"010303","name":"已付款订单","parentId":"0103","url":"${pageContext.request.contextPath}/adminOrder_findByState.action?page=1&state=2","icon":"","order":"1","isHeader":"0","childMenus":""},
						{"id":"010304","name":"已发货订单","parentId":"0103","url":"${pageContext.request.contextPath}/adminOrder_findByState.action?page=1&state=3","icon":"","order":"1","isHeader":"0","childMenus":""},
						{"id":"010305","name":"已完成订单","parentId":"0103","url":"${pageContext.request.contextPath}/adminOrder_findByState.action?page=1&state=4","icon":"","order":"1","isHeader":"0","childMenus":""}
					]},
					{"id":"0104","name":"会员管理","parentId":"01","url":"","icon":"","order":"1","isHeader":"0","childMenus":[
						{"id":"010401","name":"用户列表","parentId":"0104","url":"${pageContext.request.contextPath}/userAdmin_findAll.action?page=1","icon":"","order":"1","isHeader":"0","childMenus":""}
					]}
				]}
				];
