...
<body>
	...
	<form id="Form1" name="Form1"
		...
		<table cellSpacing="1" cellPadding="0" width="100%" align="center"
			...
			<TBODY>
				<tr>
					<td class="ta_01" align="center" bgColor="#afd1f3"><strong>订单列 表</strong></TD>
				</tr>
				<tr>
					<td class="ta_01" align="center" bgColor="#f5fafe">
						<table cellspacing="0" cellpadding="1" rules="all"
							...
							<tr
								...
								<td align="center" width="17%">总金额</td>
								<td align="center" width="17%">收货人</td>
								<td align="center" width="17%">订单状态</td>
								<td align="center" width="17%">订单详情</td>								
							</tr>
							<s:iterator var="order" value="pageBean.list" status="status">
								<tr onmouseover="this.style.backgroundColor = 'white'"
									...
									<td style="CURSOR: hand; HEIGHT: 22px" align="center" width="17%">
										...
										<a href="adminOrder_updateState.action?oid=<s:property value="#order.oid"/>">
									...
									<td width="7%" align="center">
										<input id="but<s:property value="#order.oid"/>"
										style="	background-color: #DAE6FF;cursor: hand;text-align: center;height: 25px;width:80px;"
										type="button" name="add" value="订单详情" onclick="showDetail(<s:property value="#order.oid"/>)" />
