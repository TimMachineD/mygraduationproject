...
<html>
  <head>
	...
	<link rel="stylesheet" href="admin/common/layui/css/layui.css">
  ...
  <body class="login-bg">
    <div class="login-box">
        ...
        <div class="login-main">
			<form action="${pageContext.request.contextPath }/adminUser_login.action" class="layui-form" method="post">
